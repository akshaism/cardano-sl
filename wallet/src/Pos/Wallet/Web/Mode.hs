...
import           Pos.DB.Block (dbGetBlockRealDefault, dbGetUndoRealDefault, dbPutBlundRealDefault)
...
instance HasConfiguration => MonadDBRead WalletWebMode where
    ...
    dbGetBlock = dbGetBlockRealDefault
    dbGetUndo = dbGetUndoRealDefault

instance HasConfiguration => MonadDB WalletWebMode where
    dbPut = dbPutDefault
    dbWriteBatch = dbWriteBatchDefault
    dbDelete = dbDeleteDefault
    dbPutBlund = dbPutBlundRealDefault
